...
// Ejercicio 1: Agregar horas a traumatologia
...
// Ejercicio 2: Eliminar primer y último registro de Radiología

// se elimina primer registro  de Radiologia
radiologia.shift(
)

// se elimina ultimo registro  de Radiologia
radiologia.pop(
)
...
// Ejercicio 3: Lista Consultas Medicas Dental
document.write("<hr>")
...
// Ejercicio 4: listado total de todos los pacientes que se atendieron en el centro médico
document.write(`<h2>Listado Pacientes Centro Medico</h2>`)

const arrayTotal = [...radiologia, ...traumatologia, ...dental]

arrayTotal.forEach((d, i) => {
    document.write(`<p>${d.paciente}</p>`)
})

document.write("<hr>")

// Ejercicio 5: Filtrar pacientes de ISAPRE de Dental
...
// Ejercicio 6: Filtrar pacientes de FONASA de Traumatología
